...
$(function(){
r=function(){dpi=window.devicePixelRatio;var e=document.querySelector('.un39');e.setAttribute('src',(dpi>1)?'images/button_normal-264.png':'images/button_normal-132.png');
var e=document.querySelector('.un40');e.setAttribute('src',(dpi>1)?'images/button_normal-264.png':'images/button_normal-132.png');
var e=document.querySelector('.un41');e.setAttribute('src',(dpi>1)?'images/button_normal-264.png':'images/button_normal-132.png');
var e=document.querySelector('.un42');e.setAttribute('src',(dpi>1)?'images/button_normal-264.png':'images/button_normal-132.png');
var e=document.querySelector('.un43');e.setAttribute('src',(dpi>1)?'images/button_normal-264.png':'images/button_normal-132.png');
var e=document.querySelector('.un44');e.setAttribute('src',(dpi>1)?'images/button_normal-264.png':'images/button_normal-132.png');
var e=document.querySelector('.un45');e.setAttribute('src',(dpi>1)?'images/button_normal-264.png':'images/button_normal-132.png');
var e=document.querySelector('.un46');e.setAttribute('src',(dpi>1)?'images/button_normal-264.png':'images/button_normal-132.png');
var e=document.querySelector('.un47');e.setAttribute('src',(dpi>1)?'images/button_over-264.png':'images/button_over-132.png');
